...
Меня привлекает возможность на практике поработать с AI агентами и внести свой вклад в развитие продукта, способного принести огромную пользу пользователям. 
...
# Заметки
1. Инструменты обмениваются списком обязательств через Redis.
2. Unit-тесты находятся в папке tests.
