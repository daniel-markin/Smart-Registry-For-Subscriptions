...
```
## 4. Ограничения: что агент не умеет и почему:
Агент не всегда вызывает инструменты в правильном порядке, а также может иногда не вызвать нужный инструмент. Это связано с природой LLM. Модели "предсказывают" следующий шаг по контексту. Результат их работы недетерминирован.

# Мотивация участия в проекте
## 1. Что тебя привлекает в этом проекте?

## 2. Как ты видишь свою роль в команде?
Я хотел бы занять позицию ML инженера
## 3. Сколько часов в неделю готов уделять и на какой срок?
Готов уделять 20 часов в неделю. Срок: несколько месяцев.
